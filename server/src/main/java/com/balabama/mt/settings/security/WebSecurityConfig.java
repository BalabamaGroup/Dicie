    ...
    public WebMvcConfigurer corsConfigurer() {
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**")
                    .allowedMethods("*").allowedOrigins("http://localhost:3000", "http://localhost:8080", "http://165.232.96.113/","http://165.232.96.113:8080" ,"https://dicie.net", "https://dicie.net:8080","http://dicie.net", "http://dicie.net:8080").allowCredentials(true);
            }
        };
    }
}